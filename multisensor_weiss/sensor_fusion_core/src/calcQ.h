...
void calc_Q(double dt,  Eigen::Quaternion<double> q,
						Eigen::Matrix<double,3,1> ew,Eigen::Matrix<double,3,1> ea,
						Eigen::Matrix<double,3,1> n_a,Eigen::Matrix<double,3,1> n_ba,
						Eigen::Matrix<double,3,1> n_w,Eigen::Matrix<double,3,1> n_bw,
						double n_L,
						Eigen::Matrix<double,3,1> n_qvw,
						Eigen::Matrix<double,3,1> n_qci,
						Eigen::Matrix<double,3,1> n_pic,
						Eigen::Matrix<double,3,1> n_qmi,
						Eigen::Matrix<double,3,1> n_pig,
						Eigen::Matrix<double,3,1> n_pvw,
						double n_alpha,
						double n_beta,
						Eigen::Matrix<double,nState_,nState_>* Qd)
{
	...
	(*Qd)(25,25) = dt*(n_qmi[0]*n_qmi[0]);
	(*Qd)(26,26) = dt*(n_qmi[1]*n_qmi[1]);
	(*Qd)(27,27) = dt*(n_qmi[2]*n_qmi[2]);
	(*Qd)(28,28) = dt*(n_pig[0]*n_pig[0]);
	(*Qd)(29,29) = dt*(n_pig[1]*n_pig[1]);
	(*Qd)(30,30) = dt*(n_pig[2]*n_pig[2]);
	(*Qd)(31,31) = dt*(n_pvw[0]*n_pvw[0]);
	(*Qd)(32,32) = dt*(n_pvw[1]*n_pvw[1]);
	(*Qd)(33,33) = dt*(n_pvw[2]*n_pvw[2]);
	(*Qd)(34,34) = dt*(n_alpha*n_alpha);
	(*Qd)(35,35) = dt*(n_beta*n_beta);
};
