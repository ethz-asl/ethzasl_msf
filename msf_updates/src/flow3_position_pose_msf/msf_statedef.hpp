...
typedef boost::fusion::vector<
    ...
    msf_core::StateVar_T<Eigen::Quaternion<double>, q_iv_1>,  ///< Rotation from the IMU sensor 1 frame expressed in the IMU frame.
    ...
    msf_core::StateVar_T<Eigen::Quaternion<double>, q_wv,  ///< Rotation from the world frame to the frame in which the pose is measured expressed in the world frame.
        msf_core::AuxiliaryNonTemporalDrifting>,
...
typedef msf_core::GenericState_T<fullState_T, StateDefinition>
    EKFState;  ///< The state we want to use in this EKF.
